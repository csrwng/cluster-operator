...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineAWSHardwareSpec) DeepCopyInto(out *MachineAWSHardwareSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineAWSHardwareSpec.
func (in *MachineAWSHardwareSpec) DeepCopy() *MachineAWSHardwareSpec {
	if in == nil {
		return nil
	}
	out := new(MachineAWSHardwareSpec)
	in.DeepCopyInto(out)
	return out
}
